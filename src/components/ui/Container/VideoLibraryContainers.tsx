  ...
  return (
    <motion.div
      ...
      <div className="m-5 flex flex-col items-start gap-5">
        <section className="dark:text-white text-primary flex items-center gap-x-2 font-[400] text-md">
          {category === "Ergonomics" ? (
            <Target />
          ) : category === "Nutrition" ? (
            <Apple />
        ...
        <div>
          <h1 className="dark:text-red-100 text-red-900 font-[500] text-2xl">
            {title}
          </h1>
