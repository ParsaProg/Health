...
export default function VideoLibraryContainer({
  ...
  return (
    <div className="z-10 group hover:scale-[1.03] transition-all duration-500 cursor-pointer dark:bg-slate-900 bg-white rounded-lg shadow-md dark:shadow-[#ffffff15] shadow-[#0000001a] w-[520px] h-[500px] border-[1px] dark:border-slate-600 border-slate-300 flex flex-col items-start justify-center gap-y-3">
